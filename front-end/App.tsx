...
export default function App () {
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <HeaderBar title='Paul Dill Portfolio' id="top"/>
      ...
      <View style={styles.aboutContainer}>
        <Text style={[fontStyles.header2, { alignSelf: 'center', borderBottomWidth: 2, borderBottomColor: 'blue', marginBottom: 8 }]} nativeID="about">About me</Text>
        <ResponsiveImageText>
      ...
      <View style={styles.servicesContainer}>
        <Text style={[fontStyles.header3, { alignSelf: 'center' }]} nativeID="services">Services</Text>
      ...
      <View style={styles.projectsContainer}>
        <Text style={[fontStyles.header3, { alignSelf: 'center' }]} nativeID="projects">Projects</Text>
      ...
      <View style={styles.openSourceContainer}>
        <Text style={[fontStyles.header3, { alignSelf: 'center' }]} nativeID="opensource">Open Source Contributions</Text>
        <Text style={[fontStyles.paragraph, { alignSelf: 'center', width: '80%' }]}>Open source projects will go here in a grid/flex layout</Text>
      </View>

      <View style={styles.contactContainer}>
        <Text style={[fontStyles.header3, { alignSelf: 'center' }]} nativeID="contact">Contact Me</Text>
